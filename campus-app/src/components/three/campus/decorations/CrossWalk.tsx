...
export default function CrossWalk(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF(`${getPublicPath()}/3d/road/cross-walk.glb`) as GLTFResult;
  return (
...
useGLTF.preload(`${getPublicPath()}/3d/road/cross-walk.glb`);
