...
export default function Desk(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF('./public/3d/desk/desk.glb') as GLTFResult;
  ...
  return (
    <group ref={group} {...props} dispose={null} position={position} rotation={rotation}>
      <group scale={[0.0025, 0.0025, 0.0025]}>
        <mesh geometry={nodes.网格045.geometry} material={materials['BOOK COVER']} />
        <mesh geometry={nodes.网格045_1.geometry} material={materials['DARK BROWN MATTE.002']} />
        <mesh geometry={nodes.网格045_2.geometry} material={materials['胡桃木.001']} />
        <mesh geometry={nodes.网格045_3.geometry} material={materials.漆白} />
        <mesh geometry={nodes.网格045_4.geometry} material={materials['Material #25.001']} />
        ...
        <mesh geometry={nodes.网格045_10.geometry} material={materials.HUISHE} />
        <mesh geometry={nodes.网格045_11.geometry} material={materials['Material #32']} />
        <mesh geometry={nodes.网格045_12.geometry} material={materials.ANU} />
        <mesh geometry={nodes.网格045_13.geometry} material={materials['BLUE MATTE']} />
        <mesh geometry={nodes.网格045_14.geometry} material={materials['WHITE MATTE']} />
        <mesh geometry={nodes.网格045_15.geometry} material={materials.F} />
        <mesh geometry={nodes.网格045_16.geometry} material={materials.Default} />
        <mesh geometry={nodes.网格045_17.geometry} material={materials['TAN PLASTIC']} />
        <mesh geometry={nodes.网格045_18.geometry} material={materials['TAN PLSTC SHINY']} />
        <mesh geometry={nodes.网格045_19.geometry} material={materials.BUTTONS} />
        <mesh geometry={nodes.网格045_20.geometry} material={materials.CHROME} />
      </group>
    </group>
  );
}

useGLTF.preload('./public/3d/desk/desk.glb');
